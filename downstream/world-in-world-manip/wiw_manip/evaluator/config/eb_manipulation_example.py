# examples for slide block to color target
slide_examples_RLbench = [
"""Human Instruction: Slide the block towards the green plane.
Input: {'object 1': [45, 13, 18], 'object 2': [72, 20, 18], 'object 3': [50, 42, 17], 'object 4': [36, 42, 18], 'object 5': [69, 39, 15], 'object 6': [50, 77, 17]}
Output: {
    "visual_state_description": ... (omit)
    "reasoning_and_reflection": ... (omit)
    "language_plan": "1. Move the gripper to the red block's position at [36, 42, 18]. 2. Close the gripper to pick up the block. 3. Move the gripper to the green plane's position at [69, 39, 15]. 4. Open the gripper to release the block onto the green plane.",
    "executable_plan": "[[36, 42, 18, 0, 60, 36, 1], [36, 42, 18, 0, 60, 36, 0], [69, 39, 18, 0, 60, 77, 0], [69, 39, 18, 0, 60, 77, 1]]"
}""",
"""Human Instruction: Slide the block onto the yellow plane.
Input: {'object 1': [33, 19, 17], 'object 2': [57, 47, 18], 'object 3': [61, 35, 15], 'object 4': [40, 70, 17], 'object 5': [71, 62, 15], 'object 6': [24, 55, 17]}
Output: {
    "visual_state_description": ... (omit)
    "reasoning_and_reflection": ... (omit)
    "language_plan": "1. Move the gripper to the blue block's position at [57, 47, 18]. 2. Close the gripper to pick up the block. 3. Move the gripper to the yellow plane's position at [71, 62, 15]. 4. Open the gripper to release the block onto the yellow plane.",
    "executable_plan": "[[57, 47, 18, 0, 60, 40, 1], [57, 47, 18, 0, 60, 40, 0], [71, 62, 18, 0, 60, 85, 0], [71, 62, 18, 0, 60, 85, 1]]"
}"""
]
# examples for place_into_shape_sorter_color
place_examples_RLbench = [
...
Output: {
    "visual_state_description": ... (omit)
    "reasoning_and_reflection": ... (omit)
    "language_plan": "1. Move the gripper above the red star at [65, 11, 17]. 2. Lower the gripper to grasp the star. 3. Lift the gripper with the object. 4. Move the gripper above the shape sorter at [40, 64, 37]. 5. Lower and release the star into the sorter.",
    "executable_plan": [
        [51, 38, 25, 0, 60, 26, 1],
        [51, 38, 17, 0, 60, 26, 0],
        [51, 38, 27, 0, 60, 26, 0],
...
Output: {
    "visual_state_description": ...(omit)
    "reasoning_and_reflection": ...(omit)
    "language_plan": "1. Move the gripper above the maroon star at [29, 38, 17]. 2. Lower the gripper to grasp the star. 3. Lift the gripper with the object. 4. Move the gripper above the shape sorter at [64, 58, 37]. 5. Lower and release the star into the sorter.",
    "executable_plan": [
    [29, 39, 24, 0, 60, 109, 1],
    [29, 38, 16, 0, 60, 109, 0],
    [30, 40, 26, 0, 60, 109, 0],
...
# examples for stack_cubes_color
stack_examples_RLbench = [
"""Human Instruction: Put the blue cup on top of the red cup.
Input: {'object 1': [34, 22, 17], 'object 2': [56, 33, 17], 'object 3': [41, 62, 17], 'object 4': [72, 68, 17]}
Output: {
    "visual_state_description": ... (omit)
    "reasoning_and_reflection": ... (omit)
    "language_plan": "1. Grasp the blue cup by its side wall (offset from center) near [56, 33, 17] and align yaw for stacking. 2. Lift the cup. 3. Move above the red cup opening at [41, 62, 17]. 4. Lower to nest the blue cup into the red cup. 5. Open the gripper to release.",
    "executable_plan": [
        [56, 33, 24, 0, 60, 40, 1],
        [56, 33, 17, 0, 60, 40, 0],
        [56, 33, 27, 0, 60, 40, 0],
...
Output: {
    "visual_state_description": ...(omit)
    "reasoning_and_reflection": ...(omit)
    "language_plan": "1. Move the gripper above the olive star at [54, 53, 19]. 2. Lower the gripper to grasp the star. 3. Lift the gripper with the object. 4. Move the gripper above the red star at [39, 73, 18]. 5. Lower and release the star onto the red star.",
    "executable_plan": "[[54, 51, 28, 0, 60, 37, 1], [54, 54, 20, 0, 60, 37, 0], [54, 51, 30, 0, 60, 37, 0], [39, 74, 29, 0, 60, 7, 0], [39, 74, 26, 0, 60, 7, 1]]"
}""",
...
Output: {
    "visual_state_description": ...(omit)
    "reasoning_and_reflection": ...(omit)
    "language_plan": "1. Move the gripper above the blue cube at [35, 17, 17]. 2. Lower the gripper to grasp the cube. 3. Lift the gripper with the object. 4. Move the gripper above the red cube at [33, 76, 17]. 5. Lower and release the cube onto the red cube.",
    "executable_plan": "[[36, 16, 25, 0, 60, 34, 1], [36, 16, 17, 0, 60, 34, 0], [36, 16, 27, 0, 60, 34, 0], [32, 76, 24, 0, 60, 104, 0], [32, 76, 21, 0, 60, 104, 1]]"
}""",
]

# For task push buttons:
push_examples_RLbench = [
"""Human Instruction: Press the red button.
Input: {'object 1': [28, 20, 16], 'object 2': [61, 44, 16], 'object 3': [72, 68, 16], 'object 4': [38, 73, 16]}
Output: {
    "visual_state_description": ... (omit)
    "reasoning_and_reflection": ... (omit)
    "language_plan": "1. Move the gripper above the red button at [61, 44, 16]. 2. Lower the gripper to contact the button and press. 3. Hold briefly. 4. Raise the gripper back up.",
    "executable_plan": [
        [61, 44, 24, 0, 60, 45, 0],
        [61, 44, 16, 0, 60, 45, 0],
    ]
}""",
"""Human Instruction: Press the blue button, then press the green button.
Input: {'object 1': [47, 18, 16], 'object 2': [68, 37, 16], 'object 3': [39, 64, 16], 'object 4': [76, 82, 16]}
Output: {
    "visual_state_description": ... (omit)
    "reasoning_and_reflection": ... (omit)
    "language_plan": "1. Move the gripper above the blue button at [47, 18, 16]. 2. Lower to press the blue button. 3. Raise back up. 4. Move the gripper above the green button at [39, 64, 16]. 5. Lower to press the green button. 6. Raise back up.",
    "executable_plan": [
        [47, 18, 24, 0, 60, 37, 0],
        [47, 18, 16, 0, 60, 37, 0],
    ]
...
# For task insert onto square_peg (revised to max 5 steps each)
insert_examples_RLbench = [
"""Human Instruction: Insert the square ring onto the square peg.
Input: {'object 1': [34, 22, 18], 'object 2': [46, 27, 18], 'object 3': [58, 41, 18], 'object 4': [71, 58, 36]}
Output: {
    "visual_state_description": ... (omit)
    "reasoning_and_reflection": ... (omit)
    "language_plan": "1. Move the gripper above the square ring at [46, 27, 18]. 2. Lower and close to grasp the ring. 3. Move above the square peg at [71, 58, 36] and align orientation. 4. Lower to insert the ring onto the peg. 5. Open to release the ring.",
    "executable_plan": [
        [46, 27, 26, 0, 60, 30, 1],
        [46, 27, 18, 0, 60, 30, 0],
        [71, 58, 48, 0, 60, 90, 0],
...
"""Human Instruction: Pick up the square ring and insert it onto the square peg.
Input: {'object 1': [33, 41, 17], 'object 2': [52, 35, 17], 'object 3': [60, 75, 36], 'object 4': [79, 68, 18]}
Output: {
    "visual_state_description": ... (omit)
    "reasoning_and_reflection": ... (omit)
    "language_plan": "1. Move the gripper above the square ring at [52, 35, 17]. 2. Lower and close to grasp the ring. 3. Move above the square peg at [60, 75, 36] and align yaw. 4. Lower to insert the ring onto the peg. 5. Open to release the ring.",
    "executable_plan": [
        [52, 35, 25, 0, 60, 20, 1],
        [52, 35, 17, 0, 60, 20, 0],
        [60, 75, 46, 0, 60, 109, 0],
...
Output: {
    "visual_state_description": "From left to right, I can see a purple cylinder at [45, 13, 18], a blue moon at [72, 20, 18], a green star at [36, 42, 18], a purple cube at [50, 42, 17], a yellow container at [70, 43, 17] and a purple container at [50, 77, 17].",
    "reasoning_and_reflection": "The task is to pick up the star located at [36, 42, 18] and place it into the yellow container located at [70, 43, 17]. The plan involves moving the gripper to the star's position, closing the gripper to pick it up, moving to the yellow container's position, and opening the gripper to release the cube into the container.",
    "executable_plan": "[[36, 42, 18, 6, 61, 36, 1], [36, 42, 18, 6, 61, 36, 0], [47, 41, 26, 6, 61, 36, 0], [69, 39, 24, 88, 32, 77, 0], [69, 39, 24, 87, 32, 77, 1]]"
}""",
...
vlm_examples_RLbench = {
    "slide": slide_examples_RLbench,
