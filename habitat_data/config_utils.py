...
HM3D_CONFIG_PATH = "src/habitat-lab/habitat-lab/habitat/config/benchmark/nav/objectnav/objectnav_hm3d.yaml"
HM3D_PN_CONFIG_PATH = "src/habitat-lab/habitat-lab/habitat/config/benchmark/nav/pointnav/pointnav_hm3d.yaml"
MP3D_CONFIG_PATH = "src/habitat-lab/habitat-lab/habitat/config/benchmark/nav/objectnav/objectnav_mp3d.yaml"
MP3D_PN_CONFIG_PATH = "src/habitat-lab/habitat-lab/habitat/config/benchmark/nav/pointnav/pointnav_mp3d.yaml"
R2R_CONFIG_PATH = "src/habitat-lab/habitat-lab/habitat/config/benchmark/nav/vln_r2r.yaml"
HSSD_CONFIG_PATH = "src/habitat-lab/habitat-lab/habitat/config/benchmark/nav/objectnav/objectnav_hssd-hab.yaml"
