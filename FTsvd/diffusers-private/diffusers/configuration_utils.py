...
class ConfigMixin:
    ...
    def from_config(cls, config: Union[FrozenDict, Dict[str, Any]] = None, return_unused_kwargs=False, **kwargs):
        ...
        if "action_strategy" in unused_kwargs:
            init_dict['action_strategy'] = unused_kwargs.pop('action_strategy')
        if "task_type" in unused_kwargs:
            init_dict['task_type'] = unused_kwargs.pop('task_type')
        if "action_input_channel" in unused_kwargs:
            init_dict['action_input_channel'] = unused_kwargs.pop('action_input_channel')
        if "num_frames" in unused_kwargs:
            init_dict['num_frames'] = unused_kwargs.pop('num_frames')
        model = cls(**init_dict)
